# File: python/app/gui_agent/qwen_vl_utils.py
# Project: Tip Desktop Assistant
# Description: Image processing helpers for Qwen VLM: resize, convert, and bbox format conversions.
...
def process_image(
    ...
    *,
    ...
    - Resize down to keep pixel count small (default ~1.5MP, <=1600px longest edge).
    - Convert to JPEG with moderate quality to shrink payload size for API limits.
    """
...
if __name__ == "__main__":
    ...
    # image_ele = {
    #     "image": (
    #         "http://ofasys-multimodal-wlcb-3.oss-cn-wulanchabu.aliyuncs.com/"
    #         "data/datacomp1b/image/19774238/7218d7ceb39e82e0cafc389f326e218da623a8f2.jpg"
    #     ),
    #     "height": 444,
    #     "width": 592,
    # }
